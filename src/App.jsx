...
function App() {
  ...
  return (
    <Router>
      <div className="pt-6 px-4 md:px-[48px]">
        ...
        <Routes>
          <Route path="/" element={
            <div>
              <p className="font-bold text-center text-[4rem] md:text-[13.9rem] leading-none mt-10">
                ART & LIFE
              </p>
              ...
              <div className="flex flex-col lg:flex-row gap-20 mt-20">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex flex-col justify-between gap-6 flex-1">
                        <div>
                          ...
                          <p className="text-xs max-w-xl mt-2">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas dui id ornare arcu odio ut sem. Cras ornare arcu dui vivamus arcu felis bibendum ut. Porttitor leo a diam.
                          </p>
                        </div>
                ...
                <div className="flex flex-col gap-12 max-w-sm w-full">
                  <div>
                    ...
                    <button className="mt-4 bg-black text-white px-4 py-2 text-xs">
                      BUTTON
                    </button>
                  </div>
