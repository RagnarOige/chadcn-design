    ...
    <div className="">
      <div className="px-4 md:px-[48px]">
          <div className="flex justify-between items-center mt-11">
            ...
            <p className=" text-xl font-bold  ">MAGAZINE</p>
          </div>

          <div className="flex flex-col md:flex-row gap-10 mt-16">
            <p className="font-bold text-4xl md:text-[4.2rem] leading-tight max-w-md">HOPE DIES LAST</p>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 mt-18">
        ...
        <div className="flex flex-col md:flex-row gap-10 mt-16  ">
          ...
          <div className="flex flex-col gap-4 md:w-1/3 relative md:left-33 ">
            <div className="flex flex-row gap-4 items-center">
              <img src="pics/gronberg.png" alt="" className="w-20 h-20 rounded-full" />
              <p className="font-semibold text-lg w-20 ">Jakob Gronberg</p>
          ...
          <div className="md:w-2/4 flex flex-col gap-6 text-sm leading-6">
            ...
            <div className="text-3xl md:text-4xl font-bold ">“The greatest glory in living lies not in never falling, but in rising every time we fall.</div>
        ...
        <hr className="border-black mt-24" />
          ...
          <p className="font-bold text-4xl md:text-6xl">LATEST POSTS</p>
