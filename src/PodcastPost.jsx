      ...
      <div className="px-4 md:px-[48px]">
        ...
        <div className="flex flex-col md:flex-row gap-10 mt-16  ">
          ...
          <div className="flex flex-col gap-4 md:w-1/3 relative md:left-33 ">
            <div className="relative mt-4 ">
              <img src="pics/zebra.png" className="w-62 h-62 object-cover" />
            ...
            <div className="flex gap-26 mt-1">
          ...
          <div className="md:w-2/4 flex flex-col gap-6 text-sm leading-6">
              <p className='font-semibold'>EPISODE 01</p>
              <p className='font-bold text-3xl md:text-7xl leading-tight'>SAVE THE WORLD FROM OURSELVES!</p>
        ...
        <hr className="border-black mt-24" />
          ...
          <div className="flex justify-between items-center mt-10">
              <p className="font-bold text-4xl md:text-6xl">Latest Episodes</p>
